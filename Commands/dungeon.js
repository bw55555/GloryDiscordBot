...
module.exports = async function (message, user) {
    ...
    if (user.dungeonts == undefined && functions.isCD(user, ts, "crystalmines")) { return functions.replyMessage(message, "You can enter the crystal mines in "+functions.displayTime(ts, user.cooldowns.crystalmines)) }
