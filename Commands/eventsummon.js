...
module.exports = async function (message, user) {
    ...
    if (devData.halloweenevent != undefined && ts > devData.halloweenevent.start && ts < devData.halloweenevent.end) {
        ...
        let raidoptions = [
            ...
            { "name": "Star Queen", "url": "https://cdn.discordapp.com/attachments/547415056065757194/792921517133529098/images.jpeg", "level": 300, "health": 3000000, "attack": 2400, "reward": 90000000 }
        ]
        let raidnum = 4;
