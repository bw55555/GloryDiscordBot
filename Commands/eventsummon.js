...
module.exports = async function (message, user) {
    ...
    if (devData.halloweenevent != undefined && ts > devData.halloweenevent.start && ts < devData.halloweenevent.end) {
        ...
        let raidoptions = [
            ...
            { "name": "Keqing Pinata", "url": "https://cdn.discordapp.com/attachments/531858145480540170/901089548946272316/unknown.png", "level": 126, "health": 1266666, "attack": 666, "reward": 66666666, "ability": { 'stun': 0.06, 'defense': -100 }, "abilitydesc": "6% chance to stun, receives double the damage. " }
        ]
        let raidnum = 4;
