...
module.exports = function (message) {
  ...
  if (userData[id].cooldowns.merge > ts) { return functions.replyMessage("You cannot merge now. Try again in " + functions.calcTime(userData[id].cooldowns.merge,ts)+" seconds.") }
