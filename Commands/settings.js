...
module.exports = async function (message, user) {
    ...
    if (word2 == "prefix") {
        ...
        functions.setProp("serverData", { "_id": message.guild.id }, { $set: {"prefix": words[2]}})
    ...
    if (word2 == "disable") {
        ...
        functions.setProp("serverData", { "_id": message.guild.id }, { $push: { "disabledChannels": message.channel.id } })
    }
    if (word2 == "enable") {
        if (serverData[message.guild.id].disabledChannels.indexOf(message.channel.id) == -1) {
        ...
        functions.setProp("serverData", { "_id": message.guild.id }, { $pull: { "disabledChannels": message.channel.id } })
