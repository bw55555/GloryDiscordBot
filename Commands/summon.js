    ...
    return Promise.all([functions.getObject("mobData", message.channel.id)]).then(ret => {
        ...
        if (raid == false) {
            ...
            if (message.channel.type != "dm" && message.channel.name == "treant-raid") {
                ...
                functions.summon(raid, undefined, 25, "Treant Boss", 'https://i.imgur.com/1fbm4us.jpg')
            }
                ...
                functions.summon(raid, undefined, 25, 50, "Kraken Boss", 'https://i.imgur.com/mGKIsnX.jpg')
            }
                ...
                functions.summon(raid, undefined, 50, 75, "Dragon Boss", 'https://i.imgur.com/YCdZZmT.jpg')
            }
                ...
                functions.summon(raid, undefined, 75, 100, "Deity Boss", 'https://i.imgur.com/o842h20.jpg')
            }
