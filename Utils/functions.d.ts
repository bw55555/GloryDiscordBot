...
export function raidAttack(message: Message, user: JSON, raid: JSON, resummon: boolean): void
export function raidAttack(message: Message, user: JSON, raid: JSON, resummon: boolean, isguild: boolean): void
export function raidAttack(message: Message, user: JSON, raid:JSON, resummon:boolean, isguild:boolean, isevent: boolean): void
